...
#save indices files
train_indices.dump("train_indices_tenc.dat")
val_indices.dump("val_indices_tenc.dat")
test_indices.dump("test_indices_tenc.dat")
...
with open('/scratch/users/qingyin/output/embeddinge_matrix_tenc.dat', 'wb') as outfile:
    pickle.dump(embedding_matrix, outfile, pickle.HIGHEST_PROTOCOL)
